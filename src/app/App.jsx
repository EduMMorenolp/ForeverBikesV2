...
function App() {
  ...
  const bikeData = {
    ...
    colors: [
      { id: 'roja', name: 'Rojo', hex: '#FF0000', image: `${base}images/bikes/CITY 1.8 roja.png` },
      { id: 'negra', name: 'Negro', hex: '#000000', image: `${base}images/bikes/CITY 1.8 negra.png` },
      { id: 'fucsia', name: 'Fucsia', hex: '#F70180', image: `${base}images/bikes/CITY 1.8 fucsia.png` },
      { id: 'naranja', name: 'Naranja', hex: '#FF8C00', image: `${base}images/bikes/CITY 1.8 naranaja.png` }
    ]
  }
    ...
    <div className="layout">
      <header className="header">
        <div className="container header-content">
          <img src={`${base}logo.webp`} alt="Forever Bikes Logo" className="header-logo-img" />
